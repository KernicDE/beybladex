...
// club-run tournaments, and the "Neues Club-Event" CTA (shown to the owner, ACTIVE isAdmin
// members, and global ORGANIZER/ADMIN sessions — the same rule the API enforces; it links
// to /events/new?clubId= which pre-selects the club in the form).
