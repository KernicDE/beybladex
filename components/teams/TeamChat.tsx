// components/teams/TeamChat.tsx (issue #198)
// Client-side team chat. Mirrors components/clubs/ClubChat.tsx exactly (initial GET, then
// live updates over EventSource, merge-by-id dedup, capped buffer).
'use client'
...
export function TeamChat({ slug, viewer }: { slug: string; viewer: { userId: string | null; canManage: boolean } }) {
  ...
  const base = `/api/teams/${encodeURIComponent(slug)}/messages`
