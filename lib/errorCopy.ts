...
const COPY: Record<string, string> = {
  ...
  invalid_form: 'Ungültige Anfrage (Formular fehlerhaft).',
  invalid_image: 'Das Bild ist ungültig oder zu groß (maximal 5 MB).',
  invalid_image_type: 'Das Dateiformat wird nicht unterstützt (JPG, PNG, WebP, GIF oder AVIF).',
